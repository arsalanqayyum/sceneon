...
@section('admin-content')
            ...
            <div class="container">
                ...
                <table class="table table-bordered">
                    ...
                    @foreach($prodcat as $post)
                        ...
                        <!--Delete Modal -->
                        <form method="GET" action="{{route('deleteprodcat',$post->id)}}">
                            {{csrf_field()}}
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <input type="text" name="cat" placeholder="New Category" value="{{$post->prod_cat}}">
                                        </div>
                                        <div class="modal-footer">
    ...
    <!-- Modal -->
    <form method="POST" action="{{route('insertprodcat')}}">
        {{csrf_field()}}
        <div id="myModal" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Add New Preoduct Category</p>

                        <input type="text" name="cat" placeholder="New Product Category">
                    </div>
                    <div class="modal-footer">
                        <input type="submit" value="submit" class="btn btn-success">
                    </div>
